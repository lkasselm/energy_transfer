...
> **Historical design doc.** This describes the original standalone Parthenon
> example driver (`athenapk/external/parthenon/example/energy_transfer/`,
> left untouched as a reference implementation). The physics/terminology
> here is still accurate, but the architecture described in this file was
> superseded by the `energy_transfer` library in this repo — see
> [README.md](README.md) for the current API.

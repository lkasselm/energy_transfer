...
// entry of result.spectra as three records "<name>/pow_sum", "<name>/k_sum",
// "<name>/count_sum" (matching parthenon::utils::fft::CalcSpectrum's
// [num_bins, 3] layout). shell_edges/n_shells/binning are written as
